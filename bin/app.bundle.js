...
/***/ function(module, exports, __webpack_require__) {
	...
	var data = [{ id: 1, author: "Peniel He", text: "This is one comment" }, { id: 2, author: "Jordan Walke", text: "This is *another* comment" }];
	...
	var CommentBox = React.createClass({
		...
		handleCommentSubmit: function handleCommentSubmit(comment) {
			...
			// by an id generated by the server. In a production application
			// you would likely not use Date.now() for this would have a more robust
			// system in place.
			comment.id = Date.now();
	...
	ReactDOM.render(React.createElement(CommentBox, { url: 'api/comments.php', pollInterval: 20000 }), document.getElementById('example'));
